            ...
            {isLoggedIn ? (
              ...
              <>
                ...
                <Link to="/moderator">
                  <Button variant="outline" size="sm" className="gap-2">
                    <UserPlus className="h-4 w-4" />
                    <span className="hidden sm:inline">Login as Moderator</span>
                  </Button>
                </Link>
              </>
            )}
...
// import { Link, useLocation, useNavigate } from "react-router-dom";
// import { Bell, Menu, Search, User, LogIn, UserPlus, LogOut, ArrowRight } from "lucide-react";
// import { Button } from "../ui/button";
...
//                   <span className="hidden sm:inline">Logout</span>
//                 </Button>
//                 {/* View as Moderator Button */}
//                 <Link to="/moderator)">
//                   <Button variant="outline" size="sm" className="gap-2">
//                     <User className="h-4 w-4" />
//                     <span className="hidden sm:inline">View as Moderator</span>
//                   </Button>
//                 </Link>
//               </>
//             ) : (
