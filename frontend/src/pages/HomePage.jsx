    ...
    <div className="flex flex-col gap-16 pb-20">
      ...
      <section className="relative flex flex-col items-center text-center pt-8 md:pt-12">
        ...
        <p className="mt-6 text-md md:text-xl text-muted-foreground max-w-2xl">
          Report local civic issues, track their status, and see how your
          community is improving. CivicConnect helps residents and local
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mt-16 w-full max-w-4xl">
          {[
            ...
            <div
              key={i}
              className="bg-card/50 p-4 rounded-lg border border-white/10"
            >
      ...
      <section className="grid md:grid-cols-2 gap-8 md:gap-12">
        <div className="glass-card p-6 rounded-xl">
          ...
          <p className="text-muted-foreground mb-4">
            Submit detailed reports about infrastructure problems, public
            services, safety concerns and more. Include images, location data,
            and categorize your issues for faster resolution.
          </p>
          {/* Redirect to report page */}
          <Link to="/report">
            <Button
        ...
        <div className="glass-card p-6 rounded-xl">
          ...
          <p className="text-muted-foreground mb-4">
            Follow the progress of reported issues from submission to
            resolution. Get notified when your reports change status or receive
            comments from officials or other community members.
          </p>
        ...
        <div className="glass-card p-6 rounded-xl">
          ...
          <p className="text-muted-foreground mb-4">
            Explore issues in your community through an interactive map.
            Discover problem areas, see clustering of similar issues, and find
            reports in your neighborhood.
          </p>
        ...
        <div className="glass-card p-6 rounded-xl">
          ...
          <p className="text-muted-foreground mb-4">
            Access comprehensive analytics about civic issues in your area. View
            trends over time, resolution metrics, and insights about the most
      ...
      <section className="mt-8 flex flex-col items-center text-center">
        <div className="w-full max-w-3xl p-8 rounded-2xl bg-gradient-to-br from-primary/20 via-accent/20 to-primary/10 border border-white/10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">
            Join the Community Improvement Movement
          </h2>
          <p className="text-muted-foreground mb-6">
            Be part of the solution. Create an account to start reporting
            issues, tracking updates, and helping make your community better.
          </p>
          <Link to="/register">
