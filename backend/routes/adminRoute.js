...
adminRouter.get("/me", authMiddleware, authorizeroles("admin"), getCurrentAdmin);
adminRouter.get("/moderators", authMiddleware, authorizeroles("admin"), getModerators);
adminRouter.get("/issues", authMiddleware, authorizeroles("admin"), getIssues);
adminRouter.get("/stats", authMiddleware, authorizeroles("admin"), getAdminStats);
